        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                <div class="hidden sm:ml-6 sm:flex sm:space-x-8 ml-10">
                    <a href="#" class="inline-flex items-center px-1 pt-1 text-sm font-medium hover:underline">Belanja</a>
                    <a href="#" class="inline-flex items-center px-1 pt-1 text-sm font-medium hover:underline">Riwayat</a>
                    <a href="#" class="inline-flex items-center px-1 pt-1 text-sm font-medium hover:underline">Upgrade</a>
                    <a href="#" class="inline-flex items-center px-1 pt-1 text-sm font-medium hover:underline">Pesanan</a>
